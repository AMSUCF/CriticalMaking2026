...
- **Use AI to prototype this larger P5 visualization.** Using the same methods we tried last week in generation, work with [Claude Code](https://claude.ai/code) to generate a prototype of the more complex P5.js visualization you've envisioned. Remember to specify that you are using P5.js, and work to be as clear as possible on the goals of your visualization and data.
